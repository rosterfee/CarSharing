    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link">Каталог<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown6">
                    <div class="form-check dropdown-item">
                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" name="brand_bmw">
                        <label class="form-check-label" for="defaultCheck1">
                            BMW
                        </label>
                    </div>
                    <div class="form-check dropdown-item">
                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck2" name="brand_nissan">
                        <label class="form-check-label" for="defaultCheck2">
                            Nissan
                        </label>
                    </div>
